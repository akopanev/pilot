...
5. Information disclosure — error messages, logs, debug info leaking internals
...
3. Question every abstraction — each interface/abstraction must solve a real problem
